...
FLOW_CATALOG = [
    ...
    {
        "id": "daily-monthly-report-automation",
        "name": "Daily / Monthly Report Automation",
        "industry": "operations",
        "genre": "reporting",
        "summary": "Use past completed reports and current source folders to draft daily or monthly reports, then ask GrillMe-style questions when facts are unclear.",
        "tools": ["Local folders", "Past reports", "CSV / attachments", "AI assistant", "Human reviewer"],
        "sample_columns": ["period", "source_folder", "past_report", "metric", "change", "owner", "status"],
        "steps": [
            _step("collect_past", "Collect past completed reports", "Local folders", "Past daily, weekly, or monthly reports", "Style and section evidence", False),
            _step("collect_materials", "Collect current materials", "Local folders", "CSV, meeting notes, attachments, photos, and task logs", "Current source packet", False),
            _step("analyze", "Build style profile and required-field checklist", "AI assistant", "Past reports and current source packet", "Writing profile and missing-fact list", True),
            _step("grill", "Ask one GrillMe question at a time for unclear facts", "AI assistant + human owner", "Missing-fact list", "Answered clarification log", True),
            _step("draft", "Draft daily or monthly report", "AI assistant", "Source packet and clarification log", "Report draft", True),
            _step("approve", "Human owner approves final report", "Human reviewer", "Report draft", "Approved report file", True),
        ],
        "success_metrics": ["report_drafting_time", "missing_fact_count", "draft_acceptance_rate", "approval_cycle_time"],
    },
    {
