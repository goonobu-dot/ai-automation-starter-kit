...
REQUIRED_FILES = [
    ...
    "docs/archive/GRILL_ME_PROMPTS.md",
    "docs/archive/GRILL_ME_PROMPTS.ja.md",
    "docs/archive/GRILL_ME_CHECKLISTS.md",
    "docs/archive/GRILL_ME_CHECKLISTS.ja.md",
    ...
    "docs/SIDE_HUSTLE_MARKET_UPDATE_2026.ja.md",
...
REQUIRED_README_SNIPPETS = [
    ...
    "ai-automation-kit command-center",
    "ai-automation-kit skill-pack",
    "ai-automation-kit approval-gate",
    "ai-automation-kit mcp-connector-plan",
    "ai-automation-kit agent-team",
    "ai-automation-kit workflow-explainer",
    "ai-automation-kit eval-loop",
    "ai-automation-kit self-host-pack",
    "ai-automation-kit connector-catalog",
    "ai-automation-kit script-ui-pack",
    "ai-automation-kit knowledge-rag-pack",
    "ai-automation-kit automation-hooks",
    "ai-automation-kit governance-pack",
    ...
    "docs/GETTING_STARTED.ja.md",
    "docs/INDEX.md",
    "goonobu-dot.github.io/ai-automation-starter-kit/manual.html",
...
REQUIRED_CLI_DOC_SNIPPETS = [
    ...
    "ai-automation-kit flows install daily-monthly-report-automation",
...
REQUIRED_GENERATED_ARTIFACT_SNIPPETS = [
    ...
    "schema_proposal.json",
    "provenance.json",
    "ai_agent_review_instructions.md",
...
REQUIRED_RELEASE_SMOKE_SNIPPETS = [
    ...
    ("side-hustle-blueprints", "side-hustle-blueprints"),
    ("START_HERE_SIDE_HUSTLE_BLUEPRINTS.md", "START_HERE_SIDE_HUSTLE_BLUEPRINTS.md"),
    ("side_hustle_blueprints.html", "side_hustle_blueprints.html"),
    ("first_client_picker.md", "first_client_picker.md"),
    ("command-center", "command-center"),
    ("START_HERE_COMMAND_CENTER.md", "START_HERE_COMMAND_CENTER.md"),
    ("command_center.html", "command_center.html"),
    ("skill-pack", "skill-pack"),
    ("SKILL.md", "SKILL.md"),
    ("approval-gate", "approval-gate"),
    ("approval_gate.json", "approval_gate.json"),
    ("mcp-connector-plan", "mcp-connector-plan"),
    ("mcp_connector_plan.md", "mcp_connector_plan.md"),
    ("agent-team", "agent-team"),
    ("agent_team_roles.md", "agent_team_roles.md"),
    ("workflow-explainer", "workflow-explainer"),
    ("workflow_explainer.html", "workflow_explainer.html"),
    ("eval-loop", "eval-loop"),
    ("eval_dataset.csv", "eval_dataset.csv"),
    ("self-host-pack", "self-host-pack"),
    ("self_host_runbook.md", "self_host_runbook.md"),
    ("connector-catalog", "connector-catalog"),
    ("connector_piece_catalog.md", "connector_piece_catalog.md"),
    ("script-ui-pack", "script-ui-pack"),
    ("script_to_ui_plan.md", "script_to_ui_plan.md"),
    ("knowledge-rag-pack", "knowledge-rag-pack"),
    ("knowledge_base_pack.md", "knowledge_base_pack.md"),
    ("automation-hooks", "automation-hooks"),
    ("automation_hooks.md", "automation_hooks.md"),
    ...
    ("START_HERE_REPORT_AUTOMATION.md", "START_HERE_REPORT_AUTOMATION.md"),
    ("grill_me_report_questions.md", "grill_me_report_questions.md"),
    ("demo_report_automation.html", "demo_report_automation.html"),
    ("report-wizard session", 'report_wizard_output = output / "report-wizard-weekly"'),
    ("report_wizard_state.json", "report_wizard_state.json"),
    ("source_manifest.json", "source_manifest.json"),
    ("schema_proposal.json", "schema_proposal.json"),
    ("provenance.json", "provenance.json"),
    ("weekly_report_draft.md", "weekly_report_draft.md"),
    ("approval.json", "approval.json"),
    ("report_sha256", "report_sha256"),
    ("report-wizard serve", "report-wizard serve"),
    ("subprocess.Popen", "subprocess.Popen"),
    ("PYTHONUNBUFFERED", "PYTHONUNBUFFERED"),
    ("signal.SIGINT", "signal.SIGINT"),
    ("clean serve exit", "clean serve exit"),
    ("kill fallback", "kill fallback"),
    ...
    ("daily-monthly-report-automation", "daily-monthly-report-automation"),
