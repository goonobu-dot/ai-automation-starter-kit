...
開発者向けマニュアルのように話さない。顧客がbefore/afterを理解できる言葉で説明します。

この形で話します。

- Before: 今は人が依頼を確認し、下書きを作り、フォローを覚えている。
- After: 自動化が確認キュー、下書き、チェックリスト、レポートを準備する。
- 人間承認: 顧客や業務記録に影響するものは、人が確認してから進める。
- 最初のテスト: 架空または伏せ字データでdry-runから始める。
