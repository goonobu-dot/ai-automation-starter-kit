...
- Browser manual for six control workflow packs: [docs/control-workflows.ja.html](docs/control-workflows.ja.html) / [docs/control-workflows.html](docs/control-workflows.html)
- Honest status: the office workspace supports one monthly-report pack and 21 reusable daily packs, including five email-free work relief packs and six control workflow packs. No API key is required, and no external sending occurs.
- Separate scope note: Gmail and email automation are intentionally out of scope for the work relief and control workflow packs and will be handled as a separate project.
...
| Control workflow packs manual | [統制ワークフロー6パック手順書](docs/control-workflows.ja.html) | [Control Workflow Packs Manual](docs/control-workflows.html) |
...
For the guided prompt and the browser manuals, open [START_WITH_CODEX.md](START_WITH_CODEX.md) / [START_WITH_CODEX.ja.md](START_WITH_CODEX.ja.md), [docs/office-workspace.html](docs/office-workspace.html) / [docs/office-workspace.ja.html](docs/office-workspace.ja.html), and the control workflow manuals at [docs/control-workflows.html](docs/control-workflows.html) / [docs/control-workflows.ja.html](docs/control-workflows.ja.html).
